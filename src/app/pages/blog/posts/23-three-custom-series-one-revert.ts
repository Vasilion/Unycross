...
export const post: Post = {
  slug: 'three-custom-series-one-revert',
  title: 'Three custom series, one revert: a Lookup chart polish run',
  date: '2026-05-08',
  summary:
    'A long Lookup chart polish run: EMA cloud as a custom lightweight-charts series, 200W SMA with an indicator-warmup fix, a TradingView-style earnings badge row with a click-to-popover, and one premium marker overlay that earned itself a revert.',
