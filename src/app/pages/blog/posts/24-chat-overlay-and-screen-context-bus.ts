...
export const post: Post = {
  slug: 'chat-overlay-and-screen-context-bus',
  title: "What Nova's looking at: a chat overlay and a screen-context bus",
  date: '2026-05-09',
  summary:
    "The chat is no longer a tab you navigate to. It's an overlay that opens over whatever panel you're on, and Nova reads the panel's state before she answers. The validating moment came when she criticized her own fund picks.",
